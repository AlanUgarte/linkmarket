...
- **Categoria**: debe ser una de: `Auto`, `Hogar`, `Tecnologia`, `Televisores`, `Filmadoras y Camaras de Accion`, `Celulares`, `Computacion`, `Gadgets`, `Cocina`, `Mascotas`, `Herramientas`, `Gaming`, `Bebes`, `Deportes`, `Perfumes Hombre`, `Perfumes Mujer`, `Maquillaje`. (Mayúsculas/tildes no importan, el sitio normaliza el texto).
