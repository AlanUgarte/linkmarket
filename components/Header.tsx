...
const chipClass =
  'w-full sm:w-auto shrink-0 inline-flex items-center gap-1 sm:gap-1.5 rounded-full border border-line bg-base-900 px-3 sm:px-3.5 py-2 text-[13px] sm:text-sm font-medium text-ink whitespace-nowrap transition-colors duration-200 ease-smooth hover:border-line-strong hover:bg-base-800 active:scale-95';
